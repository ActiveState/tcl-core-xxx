...
#define PUSH_TAUX_OBJ(objPtr)					\
    do {							\
	objPtr->internalRep.twoPtrValue.ptr2 = expandNestList;	\
	expandNestList = objPtr;				\
    } while (0)

#define POP_TAUX_OBJ()								\
    do {									\
	tmpPtr = expandNestList;						\
	expandNestList = (Tcl_Obj *) tmpPtr->internalRep.twoPtrValue.ptr2;	\
