...
EXTERN void		Tcl_RegisterConfig(Tcl_Interp*interp,
				CONST char*pkgName, Tcl_Config*configuration,
...
/* 558 */
EXTERN int		Tcl_GetBignumFromObj(Tcl_Interp*interp, Tcl_Obj*obj,
				mp_int*value);
/* 559 */
EXTERN int		Tcl_TakeBignumFromObj(Tcl_Interp*interp, Tcl_Obj*obj,
				mp_int*value);
/* 560 */
